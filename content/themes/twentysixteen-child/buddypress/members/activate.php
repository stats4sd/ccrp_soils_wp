...
<div id="buddypress">
	...
	<div class="page" id="activate-page">
		...
		<?php else : ?>
			...
			<p><?php _e( 'Please provide a valid activation key. This should be automatically filled in. If it is not, you can find it in your activation email', 'buddypress' ); ?></p>
